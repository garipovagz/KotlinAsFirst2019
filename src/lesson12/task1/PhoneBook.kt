 ...
 */
class PhoneBook {
    private val phbook = mutableMapOf<String, MutableSet<String>>()
    /**
     * Добавить человека.
    ...
    fun addHuman(name: String): Boolean =
        if (phbook[name] != null) false
        else {
            phbook[name] = mutableSetOf<String>()
            true
        }
    ...
    override fun equals(other: Any?): Boolean {
        if (other is PhoneBook && phbook == other.phbook) return true
        return false
    }
